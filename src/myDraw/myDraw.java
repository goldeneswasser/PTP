...
public class myDraw {
  ...
  public static void main(String[] args) { new myDraw(); }

  /** Application constructor:  create an instance of our GUI class */
  public myDraw() { window = new DrawGUI(this); }
...
class DrawGUI extends JFrame {
  myDraw app;      // A reference to the application, to send commands to.
  Color color;
   ...
   */
  public DrawGUI(myDraw application) {
